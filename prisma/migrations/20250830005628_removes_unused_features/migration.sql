/*
  ...
  - The values [recipes,advanced_search,meal_planning,shopping_lists] on the enum `Feature` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "Feature_new" AS ENUM ('recentRecipes', 'chat', 'filters', 'lists', 'savedRecipes');
