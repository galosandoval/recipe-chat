module.exports = {
  ...
  grocerylists: [
    { name: "sweet treats", completed: false },
    { name: "savory supper", completed: false },
    { name: "friday's meals", completed: false },
    { name: "WEEKEND TREAT YO SELF", completed: false }
  ],
