export function FormLoader() {
	return (
		<div className='mt-2 flex flex-col p-5'>
			...
			<div
				className='h-4 w-52 animate-pulse rounded bg-base-300 p-5'
			...
			<div
				className='h-4 w-72 animate-pulse rounded bg-base-300 p-5'
			...
			<div className='flex gap-2'>
				<div className='flex w-1/2 flex-col'>
					...
					<div
						className='h-4 w-1/2 animate-pulse rounded bg-base-300 p-5'
						style={{
			...
			<div className='flex flex-col gap-3 p-5'>
				...
				></div>
				<div
					className='h-4 w-3/4 animate-pulse rounded bg-base-300'
					style={{ animationDuration: '1s', animationDelay: '0.75s' }}
				></div>
				<div
					className='h-4 w-3/5 animate-pulse rounded bg-base-300'
					style={{ animationDuration: '1s', animationDelay: '0.75s' }}
				></div>
				<div
					className='h-4 w-1/2 animate-pulse rounded bg-base-300'
			...
			<div className='flex flex-col gap-3 p-5'>
				...
				></div>
				<div
					className='h-4 w-1/3 animate-pulse rounded bg-base-300'
					style={{ animationDuration: '1s', animationDelay: '1s' }}
				></div>
				<div className='h-1'></div>
				<div
